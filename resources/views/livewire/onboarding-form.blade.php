        ...
        <form wire:submit.prevent="save">
            ...
            <div class="mt-5 row row-cols-1 row-cols-md-2 row-cols-lg-4">
                ...
                <div class="col form-group">
                    ...
                    <select wire:change="updateDivision"  name="campaign_id" wire:model.defer="campaign_id" class="form-control" @if($batch_no > 0) disabled @endif>
                ...
                <div class="col form-group">
                    ...
                    <select wire:change="updateJobTitle" name="division_id" wire:model.defer="division_id"class="form-control" @if($batch_no > 0) disabled @endif>
                ...
                <div class="col form-group">
                    ...
                    <select wire:model.defer="job_title" class="form-control" @if($batch_no > 0) disabled @endif>
